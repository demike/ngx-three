...
export class ThPositionalAudio<TARGS extends any[] = [listener: AudioListener]> extends ThAudio<PannerNode, TARGS> {
  @Input()
  public objRef!: PositionalAudio;
