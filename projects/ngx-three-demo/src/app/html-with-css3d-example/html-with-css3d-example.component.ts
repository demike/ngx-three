...
export class HtmlWithCSS3dExampleComponent {
  ...
  constructor() {
    ...
    /**
     * move canvas in front of css3d renderer root dom element
     * and disable pointer events for the canvas so that the dom elements of the css3d renderer are clickable
     */
